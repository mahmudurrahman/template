...
This folder contains solution-wide architecture tests for .NET 10 Starter Kit. The goal is to automatically enforce layering, dependency, and naming rules as the codebase evolves.
...
- Run all tests (including architecture tests): `dotnet test src/ERA.TradeFinanace.slnx`.
